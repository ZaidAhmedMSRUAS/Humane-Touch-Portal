    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      <div className="bg-white rounded-3xl border border-slate-200 shadow-sm p-6">
        ...
        {loading ? (
          ...
          <p className="text-xs text-slate-500 py-8 text-center">No student applications assigned currently.</p>
        ) : (
                  ...
                  <tr key={app.id} className="hover:bg-slate-50/60 transition">
                    ...
                    <td className="py-3.5 px-4 text-right">
                      <button
                        ...
                        className="px-3 py-1.5 bg-rose-50 hover:bg-rose-100 text-rose-700 font-bold rounded-xl border border-rose-200 transition text-[11px] cursor-pointer"
                      >
                        🗑️ Request Deletion
                      </button>
                    </td>
